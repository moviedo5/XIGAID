...
logoright_name: logoudc.png
logoleft_name: logoJornada2.png
font_size: 32
...
<p align="center">
![](image/elearning.title.png){width=60%}
</p>
...
<!--
**Ciencia abierta** en repositorios Git que permiten el feedback de la comunidad científica  ![Git](git.png){width=5%} 
-->
<!--![feedback](mas.png){width=5%} ![feedback](feedback2.png){width=10%}-->
